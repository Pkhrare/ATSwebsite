// AI utility functions for Waiverlyn integration
...
export const getMessageStyling = (message, userRole, projectName) => {
    ...
    if (isAI) {
        ...
        return {
            alignment: userRole === 'consultant' ? 'justify-end' : 'justify-start',
        ...
        return {
            alignment: userRole === 'client' ? 'justify-end' : 'justify-start',
